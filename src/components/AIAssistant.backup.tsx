...
export default function AIAssistant() {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (SpeechRecognition) {
        ...
        recognitionInstance.onresult = (event: any) => {
          ...
          // Only auto-submit if it's the final result
  ...
  const handleVoiceInput = () => {
    console.log('Voice input clicked, recognition:', recognition, 'isListening:', isListening);
    
    if (!recognition) {
      const errorMsg = lang === 'mr' ? 'तुमच्या ब्राउझरमध्ये व्हॉइस इनपुट उपलब्ध नाही. कृपया Chrome वापरा.' : 
                       lang === 'hi' ? 'आपके ब्राउज़र में वॉइस इनपुट उपलब्ध नहीं है। कृपया Chrome का उपयोग करें।' : 
                       'Voice input not available in your browser. Please use Chrome.';
    ...
    if (isListening) {
      ...
      try {
        ...
        if (error.message && error.message.includes('already started')) {
          toast.info(lang === 'mr' ? 'आधीच ऐकत आहे...' : 
                    lang === 'hi' ? 'पहले से सुन रहे हैं...' : 
                    'Already listening...');
        } else {
  ...
  const generateSchemeRecommendation = (schemeIds: string[], language: string): string => {
    const schemes = [
      {
        ...
        desc_en: "Free health insurance up to ₹1.5 lakh",
        desc_mr: "₹1.5 लाख पर्यंत मोफत आरोग्य विमा",
        desc_hi: "₹1.5 लाख तक मुफ्त स्वास्थ्य बीमा"
      },
      {
        id: "lek-ladki-yojana",
        ...
        desc_en: "Financial aid for girl child education (up to ₹75,000)",
        desc_mr: "मुलींच्या शिक्षणासाठी आर्थिक मदत (₹75,000 पर्यंत)",
        desc_hi: "बालिका शिक्षा के लिए वित्तीय सहायता (₹75,000 तक)"
      },
      {
        id: "shetkari-sanman-nidhi",
        name_en: "Namo Shetkari Sanman Nidhi",
        name_mr: "नमो शेतकरी सन्मान निधी",
        name_hi: "नमो शेतकारी सन्मान निधि",
        desc_en: "₹6,000 per year direct income support for farmers",
        desc_mr: "शेतकऱ्यांसाठी दरवर्षी ₹6,000 थेट उत्पन्न",
        desc_hi: "किसानों के लिए प्रति वर्ष ₹6,000 प्रत्यक्ष आय"
      },
      {
        ...
        desc_mr: "ओबीसी विद्यार्थ्यांसाठी शिष्यवृत्ती",
        desc_hi: "ओबीसी छात्रों के लिए छात्रवृत्ति"
      },
      {
        id: "solar-pump-subsidy",
        name_en: "Solar Pump Subsidy",
        name_mr: "सौर पंप अनुदान",
        name_hi: "सौर पंप सब्सिडी",
        desc_en: "Up to 95% subsidy for solar agricultural pumps",
        desc_mr: "सौर कृषी पंपांसाठी 95% पर्यंत अनुदान",
        desc_hi: "सौर कृषि पंपों के लिए 95% तक सब्सिडी"
      }
    ];

    const relevantSchemes = schemes.filter(s => schemeIds.includes(s.id));
    
    const header = {
      en: "🎯 Based on your problem, I recommend these schemes:\n\n",
      mr: "🎯 तुमच्या समस्येवर आधारित, मी या योजना सुचवतो:\n\n",
      hi: "🎯 आपकी समस्या के आधार पर, मैं ये योजनाएं सुझाता हूं:\n\n"
    };

    const footer = {
      en: "\n\n📋 Click on 'Schemes' page to apply for these schemes!\n\nWould you like more details about any specific scheme?",
      mr: "\n\n📋 या योजनांसाठी अर्ज करण्यासाठी 'योजना' पृष्ठावर क्लिक करा!\n\nतुम्हाला कोणत्याही विशिष्ट योजनेबद्दल अधिक तपशील हवे आहेत का?",
      hi: "\n\n📋 इन योजनाओं के लिए आवेदन करने के लिए 'योजनाएं' पृष्ठ पर क्लिक करें!\n\nक्या आप किसी विशिष्ट योजना के बारे में अधिक जानकारी चाहेंगे?"
    };

    let message = header[language as keyof typeof header] || header.en;
    
    relevantSchemes.forEach((scheme, index) => {
      const name = scheme[`name_${language}` as keyof typeof scheme] || scheme.name_en;
      const desc = scheme[`desc_${language}` as keyof typeof scheme] || scheme.desc_en;
      message += `${index + 1}. ${name}\n   ${desc}\n\n`;
    });

    message += footer[language as keyof typeof footer] || footer.en;
  ...
  const generateAIResponse = async (userInput: string): Promise<ChatMessage> => {
    ...
    // First, check if user's problem matches any schemes
    const schemeRecommendation = analyzeAndSuggestSchemes(userInput, lang);
