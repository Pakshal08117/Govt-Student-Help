      ...
      <section className="container mx-auto px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold mb-2">{t("applyService")}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <Label htmlFor="alternateNumber">{t("alternateNumber")}</Label>
                    <Input
                      id="alternateNumber"
                      type="tel"
                      placeholder="+91 9876543210"
            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                ...
                {isHospitalService && (
                  <>
                    <div>
                      <Label htmlFor="medicalIssue">{t("medicalIssue")} *</Label>
                      <Textarea
                        id="medicalIssue"
                        required
            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="incomeProof">{t("incomeProof")}</Label>
                    <Input
                      id="incomeProof"
                      type="file"
                      accept=".pdf,.jpg,.jpeg,.png"
                  ...
                  {isHospitalService && (
                    <div>
                      <Label htmlFor="medicalReports">{t("medicalReports")}</Label>
                      <Input
                        id="medicalReports"
                        type="file"
                        accept=".pdf,.jpg,.jpeg,.png"
                ...
                <div>
                  <Label htmlFor="otherDocuments">{t("otherDocuments")}</Label>
                  <Input
                    id="otherDocuments"
                    type="file"
                    accept=".pdf,.jpg,.jpeg,.png"
